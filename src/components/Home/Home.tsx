    ...
    <div className="max-w-2xl mx-auto pb-20 bg-gray-50 min-h-screen rounded-2xl">
            ...
            <div className="p-4">
              ...
              {post.comments > 0 && (
                <button className="text-gray-500 text-sm hover:text-gray-700">
                  {t("view_all")} {post.comments} {t("comments")}
                </button>
              )}
            </div>
          </div>
      ...
      {!isLoading && posts.length === 0 && (
        <div className="text-center py-12">
          <h3 className="text-lg font-medium text-gray-700">{t("no_posts")}</h3>
      ...
      <Modal open={isOpen} setOpen={setIsOpen}>
        <div className="h-[70vh] max-h-[600px] min-h-[400px] flex flex-col bg-white rounded-lg overflow-hidden">
          <div className="bg-indigo-600 text-white p-4">
            <h2 className="text-2xl font-bold text-center">{t("comments")}</h2>
          </div>
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {comments.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center h-full text-gray-500">
                ...
                <p className="mt-2 text-lg">{t("no_comments")}</p>
                <p className="text-sm">{t("be_first_comment")}</p>
              </div>
            )}
          </div>
